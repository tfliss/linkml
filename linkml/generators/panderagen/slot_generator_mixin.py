...
class SlotGeneratorMixin:
    ...
    def handle_multivalued_slot(self, slot, range: str) -> str:
        if (
            (slot.inlined_as_list is True and self.is_multivalued(slot)) or
